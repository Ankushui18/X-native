...
| A name is canvas chrome and is never part of an export | [Section titles export?](https://forum.figma.com/t/section-titles-are-exporting-as-part-of-the-image/13338) | the export path drops the label nodes | `t13_canvas_and_export_must_encode_the_same_fill_stack` |
