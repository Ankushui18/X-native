...
mod reliability_history_tests {
    ...
    fn reorder_node_moves_within_a_parent_with_undo_redo() {
        ...
        ed.insert_node(&root_id, Node::rect("a", 0.0, 0.0, 10.0, 10.0, Color::WHITE));
        ed.insert_node(&root_id, Node::rect("b", 20.0, 0.0, 10.0, 10.0, Color::WHITE));
        ed.insert_node(&root_id, Node::rect("c", 30.0, 0.0, 10.0, 10.0, Color::WHITE));
