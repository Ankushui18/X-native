...
impl ColorTokens {
    ...
    pub const GRAPHITE: Self = Self {
        ...
        surface_hover: [0x3c, 0x3c, 0x3c],
        surface_active: [0x44, 0x44, 0x44],
        border: [0x44, 0x44, 0x44],
        border_strong: [0x55, 0x55, 0x55],
        text_primary: [0xf5, 0xf5, 0xf5],
        text_secondary: [0xb3, 0xb3, 0xb3],
        text_dim: [0xb1, 0xb1, 0xb1],
        text_placeholder: [0xb1, 0xb1, 0xb1],
        accent: [0x0d, 0x70, 0xf6],
        accent_hover: [0x0b, 0x63, 0xd9],
        accent_active: [0x0a, 0x56, 0xc2],
        accent_ink: [0x74, 0xc0, 0xfc],
        on_accent: [0xff, 0xff, 0xff],
        selection: [0x0d, 0x99, 0xff],
        focus_ring: [0x8a, 0xd0, 0xff],
    ...
    pub const DAYLIGHT: Self = Self {
        ...
        surface_elevated: [0xf5, 0xf5, 0xf5],
        surface_hover: [0xee, 0xee, 0xee],
        surface_active: [0xe6, 0xe6, 0xe6],
        border: [0xe6, 0xe6, 0xe6],
        border_strong: [0xb0, 0xb0, 0xb0],
        text_primary: [0x1a, 0x1a, 0x1a],
        text_secondary: [0x5a, 0x5a, 0x5a],
        text_dim: [0x5a, 0x5a, 0x5a],
        text_placeholder: [0x5a, 0x5a, 0x5a],
        accent: [0x0d, 0x70, 0xf6],
        accent_hover: [0x0b, 0x63, 0xd9],
        accent_active: [0x0a, 0x56, 0xc2],
        accent_ink: [0x00, 0x66, 0xb3],
        on_accent: [0xff, 0xff, 0xff],
        selection: [0x0d, 0x98, 0xff],
        focus_ring: [0x0b, 0x7f, 0xd6],
